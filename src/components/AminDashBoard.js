...
export default function Dashboard() {
  ...
  return (
    ...
    <Link to={`/admin/adminhouse/`} style={{ color: '#000000',textDecoration: 'none'  }}>
    <ListItemButton>
      <ListItemIcon>
        <AssignmentIcon />
      </ListItemIcon>
     ...
     <Link to={`/admin/adminedu/`} style={{ color: '#000000',textDecoration: 'none'  }}>
    <ListItemButton>
      <ListItemIcon>
        <AssignmentIcon />
      </ListItemIcon>
    ...
    <Link to={`/admin/admincrop/`}style={{ color: '#000000',textDecoration: 'none'  }}>
    <ListItemButton>
      <ListItemIcon>
        <AssignmentIcon />
      </ListItemIcon>
          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            ...
            <div>
              ...
              <Grid item xs={12} md={4} lg={3}>
                ...
                >
                  <React.Fragment>
                       <Title>Toatal Loan Request</Title>
                         <Typography component="p" variant="h4">
                         150
                        </Typography>
                 <Typography color="text.secondary" sx={{ flex: 1 }}>
            ...
            <div>
              ...
              <Grid item xs={12} md={4} lg={3}>
                ...
                >
                  <React.Fragment>
                       <Title>Toatal Loan Accepted</Title>
                         <Typography component="p" variant="h4">
                         150
                        </Typography>
                 <Typography color="text.secondary" sx={{ flex: 1 }}>
            ...
            <div>
              ...
              <Grid item xs={12} md={4} lg={3}>
                ...
                >
                  <React.Fragment>
                       <Title>Toatal Transactions</Title>
                         <Typography component="p" variant="h4">
                         150
                        </Typography>
                 <Typography color="text.secondary" sx={{ flex: 1 }}>
