...
export default function Dashboard() {
  ...
  useEffect(() => {
    axios.get('http://localhost:8080/getpaidloans') // Replace with your API endpoint
      .then(response => {
  ...
  useEffect(() => {
    axios.get('http://localhost:8080/users') // Replace with your API endpoint
      .then(response => {
  ...
  return (
    ...
    <Link to={`admingold/`} style={{ color: '#000000',textDecoration: 'none'  }}>
    <ListItemButton>
      <ListItemIcon>
        <AssignmentIcon />
      </ListItemIcon>
          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            ...
            <div>
              ...
              <Grid item xs={12} md={4} lg={3}>
                ...
                >
                  <React.Fragment>
                       <Title>Toatal Loan new to recover</Title>
                         <Typography component="p" variant="h4">
                         150
                        </Typography>
                 <Typography color="text.secondary" sx={{ flex: 1 }}>
            ...
            <div>
              ...
              <Grid item xs={12} md={4} lg={3}>
                ...
                >
                  <React.Fragment>
                       <Title>Toatal Loan Recovered</Title>
                         <Typography component="p" variant="h4">
                         150
                        </Typography>
                 <Typography color="text.secondary" sx={{ flex: 1 }}>
      ...
      <Table size="small">
        <TableHead>
          <TableRow>
            ...
            <TableCell>Total LoanAount</TableCell>
            <TableCell>Months to pay</TableCell>
        ...
        <TableBody>
          {data.map((row) => (
            <TableRow key={row.id}>
              ...
              <TableCell>{row.monthstopay}</TableCell>
