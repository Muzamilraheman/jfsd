...
export default function Dashboard() {
  ...
  useEffect(() => {
    axios.get('http://localhost:8080/gethomeloan') // Replace with your API endpoint
      .then(response => {
          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={4} lg={3}>
                ...
                >
                  <React.Fragment>
                       <Title>Total Gold Loan Request</Title>
            ...
            <div>
              ...
              <Grid item xs={12} md={4} lg={3}>
                ...
                >
                  <React.Fragment>
                       <Title>Toatal Gold Loans Appected</Title>
                         <Typography component="p" variant="h4">
                         150
                        </Typography>
                 <Typography color="text.secondary" sx={{ flex: 1 }}>
      ...
      <Table size="small">
        <TableHead>
          <TableRow>
            ...
            <TableCell>Any Property</TableCell>
            <TableCell>Duration Req</TableCell>
        ...
        <TableBody>
          {data.map((row) => (
            <TableRow key={row.id}>
              ...
              <TableCell>{row.anyprop}</TableCell>
